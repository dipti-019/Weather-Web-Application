...
function Temperature({ setCity, stats }) {
  // Function to handle city change from input
  const handleCityChange = (e) => {
    setCity(e.target.value); // Update the city state in the parent component
  };
  ...
  return (
    <>
      ...
      <div className='flex align-middle justify-between'>
        ...
        <input
          type='text'
          className='bg-slate-600 border border-slate-500 text-slate-200 placeholder-slate-400 text-lg w-60 p-2 focus:outline-none focus:border-slate-400'
      ...
      {/* Display sun or moon icon based on whether it is day or night */}
